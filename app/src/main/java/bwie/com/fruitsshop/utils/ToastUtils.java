package bwie.com.fruitsshop.utils;
...
import bwie.com.fruitsshop.application.MyApplication;
...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(MyApplication.getAppContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(MyApplication.getAppContext().getResources().getString(resId), args), duration);
    }
